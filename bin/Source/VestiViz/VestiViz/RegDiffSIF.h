...
struct RegDiffSIF : public SingleInputFilterBase<TimedDatum<S, T>, TimedDatum<S, T>, CircBufL, LAlloc> {
	explicit RegDiffSIF(std::size_t window) :SingleInputFilterBase<TimedDatum<S, T>, TimedDatum<S, T>, CircBufL, LAlloc>
