...
struct ExpDecaySIF : public SingleInputFilterBase<TimedDatum<S, T>, TimedDatum<S, T>, IOWrapper, CircBufL,LAlloc> {
	explicit ExpDecaySIF(S halflife) :SingleInputFilterBase<TimedDatum<S, T>, TimedDatum<S, T>, IOWrapper, CircBufL, LAlloc>
