...
struct QCompSIF : public SingleInputFilterBase<TimedDatum<S, T>, TimedDatum<S, T>, IOWrapper, CircBufL, LAlloc> {
	explicit QCompSIF(T scale) :SingleInputFilterBase<TimedDatum<S, T>, TimedDatum<S, T>, IOWrapper, CircBufL, LAlloc>
